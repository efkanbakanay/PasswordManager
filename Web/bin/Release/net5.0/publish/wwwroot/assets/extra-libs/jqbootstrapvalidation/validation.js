    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Geçerli olmayan e-posta adresi<!-- data-validation-email-message to override -->";
        ...
        , builtInValidators: {
            ...
            , passwordagain: {
                ...
                , type: "match"
                , match: "password"
                , message: "Verilen şifreyle eşleşmiyor<!-- data-validator-paswordagain-message to override -->"
            }
            , positive: {
                name: "Positive"
                , type: "shortcut"
